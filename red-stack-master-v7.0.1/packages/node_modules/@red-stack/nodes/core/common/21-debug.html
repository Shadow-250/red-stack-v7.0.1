...
(function() {
    ...
    RED.nodes.registerType('debug',{
        ...
        onpaletteadd: function() {
            ...
            RED.popover.tooltip($("#red-ui-sidebar-debug-open"),RED._('red-stack:debug.sidebar.openWindow'));
        ...
        oneditprepare: function() {
            var none = {
                value: "none",
                label: RED._("red-stack:debug.none"),
                hasValue: false
            };
            ...
            var fullType = {
                value: "full",
                label: RED._("red-stack:debug.msgobj"),
                hasValue: false
            };
