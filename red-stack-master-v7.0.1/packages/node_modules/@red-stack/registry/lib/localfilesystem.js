...
var i18n = require("@red-stack/util").i18n;
...
function getNodeFiles(disableNodePathScan) {
    ...
    if (settings.coreNodesDir) {
        ...
        i18n.registerMessageCatalog("red-stack",defaultLocalesPath,"messages.json");
    }
    ...
    nodeFiles.forEach(function(node) {
        nodeList["red-stack"].nodes[node.name] = node;
    });
    ...
    if (!disableNodePathScan) {
        ...
        moduleFiles.forEach(function(moduleFile) {
            ...
            if (moduleFile.package['red-stack'].version) {
                nodeList[moduleFile.package.name].redVersion = moduleFile.package['red-stack'].version;
            }
