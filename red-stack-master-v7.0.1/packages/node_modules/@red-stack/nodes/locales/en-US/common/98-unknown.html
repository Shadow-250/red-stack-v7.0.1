...
<script type="text/x-red" data-help-name="unknown">
    <p>This node is a type unknown to your installation of RED-Stack.</p>
    <h3>Details</h3>
    ...
    install, any missing modules and restart RED-Stack and reimport the nodes.</p>
    <p>It is possible this node type is already installed, but is missing a dependency. Check the RED-Stack start-up
