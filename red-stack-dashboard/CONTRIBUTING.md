# Contributing to RED-Stack-Dashboard
...
- Version of RED-Stack-Dashboard - either release number if you downloaded a zip, or the first few lines of `git log` if you are cloning the repository directly.
