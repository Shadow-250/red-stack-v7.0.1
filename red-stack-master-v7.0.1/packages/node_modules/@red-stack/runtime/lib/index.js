...
var redUtil = require("@red-stack/util");
var log = redUtil.log;
 ...
 * @param {AdminAPI} adminApi - an instance of @red-stack/editor-api. <B>TODO</B>: This needs to be
 *                              better abstracted.
 * @memberof @red-stack/runtime
 */
...
function start() {
    return i18n.registerMessageCatalog("runtime",path.resolve(path.join(__dirname,"..","locales")),"runtime.json")
        ...
        .then(function() {
            ...
            if (settings.version) {
                log.info(log._("runtime.version",{component:"RED-Stack",version:"v"+settings.version}));
            }
                ...
                if (nodeMissing.length > 0) {
                    ...
                    for (i in missingModules) {
                        if (missingModules.hasOwnProperty(i)) {
                            ...
                            if (settings.autoInstallModules && i != "red-stack") {
...
var runtime = {
    ...
    library: library,
    exec: exec,
    util: require("@red-stack/util").util,
...
/**
 * This module provides the core runtime component of RED-Stack.
 * It does *not* include the RED-Stack editor. All interaction with
 * this module is done using the api provided.
 *
 * @namespace @red-stack/runtime
 */
module.exports = {
    init: init,
    start: start,
    ...
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_comms
    */
    comms: externalAPI.comms,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_flows
    */
    flows: externalAPI.flows,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_library
    */
    library: externalAPI.library,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_nodes
    */
    nodes: externalAPI.nodes,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_settings
    */
    settings: externalAPI.settings,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_projects
    */
    projects: externalAPI.projects,
    /**
    * @memberof @red-stack/runtime
    * @mixes @red-stack/runtime_context
    */
