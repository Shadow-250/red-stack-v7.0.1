...
var runtime = require("@red-stack/runtime");
var redUtil = require("@red-stack/util");

var api = require("@red-stack/editor-api");
...
/**
 * This module provides the full RED-Stack application, with both the runtime
...
module.exports = {
    /**
     * Initialise the RED-Stack application.
    ...
    init: function(httpServer, userSettings) {
        ...
        if (!userSettings.coreNodesDir) {
            userSettings.coreNodesDir = path.dirname(require.resolve("@red-stack/nodes"))
        }
    ...
    /**
     * Start the RED-Stack application.
    ...
    /**
     * Stop the RED-Stack application.
     * @return {Promise} - resolves when complete
     * @memberof red-stack
     */
    stop: function() {
     ...
     * under [red-stack.runtime]{@link red-stack.runtime}.
     *
     * @memberof red-stack
     */
