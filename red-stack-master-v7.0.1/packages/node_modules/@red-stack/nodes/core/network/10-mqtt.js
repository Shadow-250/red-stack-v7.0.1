...
module.exports = function(RED) {
            ...
            if (!node.connected && !node.connecting) {
                ...
                try {
                    ...
                    node.client.on('connect', function () {
                        ...
                        for (var id in node.users) {
                            if (node.users.hasOwnProperty(id)) {
                                node.users[id].status({fill:"green",shape:"dot",text:"red-stack:common.status.connected"});
                            }
                        }
                    ...
                    node.client.on("reconnect", function() {
                        for (var id in node.users) {
                            if (node.users.hasOwnProperty(id)) {
                                node.users[id].status({fill:"yellow",shape:"ring",text:"red-stack:common.status.connecting"});
                            }
                        }
                    })
                    ...
                    node.client.on('close', function () {
                        if (node.connected) {
                            ...
                            for (var id in node.users) {
                                if (node.users.hasOwnProperty(id)) {
                                    node.users[id].status({fill:"red",shape:"ring",text:"red-stack:common.status.disconnected"});
                                }
                            }
    ...
    function MQTTInNode(n) {
        ...
        var node = this;
        if (this.brokerConn) {
            this.status({fill:"red",shape:"ring",text:"red-stack:common.status.disconnected"});
            if (this.topic) {
                ...
                if (this.brokerConn.connected) {
                    node.status({fill:"green",shape:"dot",text:"red-stack:common.status.connected"});
                }
            }
            else {
