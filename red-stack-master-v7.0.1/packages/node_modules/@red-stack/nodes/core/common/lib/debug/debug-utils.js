...
RED.debug = (function() {
    ...
    function init(_config) {
        ...
        var filterDialog = $('<div class="red-ui-debug-filter-box hide">'+
            ...
            '<span class="button-group">'+
                '<a class="red-ui-sidebar-header-button-toggle red-ui-sidebar-debug-filter-option selected" id="red-ui-sidebar-debug-filterAll" href="#"><span data-i18n="red-stack:debug.sidebar.filterAll"></span></a>'+
                '<a class="red-ui-sidebar-header-button-toggle red-ui-sidebar-debug-filter-option" id="red-ui-sidebar-debug-filterSelected" href="#"><span data-i18n="red-stack:debug.sidebar.filterSelected"></span></a>'+
                '<a class="red-ui-sidebar-header-button-toggle red-ui-sidebar-debug-filter-option" id="red-ui-sidebar-debug-filterCurrent" href="#"><span data-i18n="red-stack:debug.sidebar.filterCurrent"></span></a> '+
            '</span>'+
            '</div>'+
        ...
        var flowCheckboxes = {};
        var debugNodeListHeader = $('<div><span data-i18n="red-stack:debug.sidebar.debugNodes"></span><span></span></div>');
        ...
        toolbar.find('#red-ui-sidebar-debug-filter span').text(RED._('red-stack:debug.sidebar.filterAll'));
        ...
        var filterButtonHandler = function(type) {
            return function(e) {
                ...
                if (filterType !== type) {
                    ...
                    $('#red-ui-sidebar-debug-filter span').text(RED._('red-stack:debug.sidebar.'+filterType));
                    refreshMessageList();
                }
            }
        }
        ...
        RED.popover.tooltip(toolbar.find('#red-ui-sidebar-debug-filter'),RED._('red-stack:debug.sidebar.filterLog'));

        toolbar.find("#red-ui-sidebar-debug-clear").on("click", function(e) {
            e.preventDefault();
            clearMessageList(false);
        });
        RED.popover.tooltip(toolbar.find("#red-ui-sidebar-debug-clear"),RED._('red-stack:debug.sidebar.clearLog'),"core:clear-debug-messages");
    ...
    function showMessageMenu(button,dbgMessage,sourceId) {
        ...
        if (!menuOptionMenu) {
            menuOptionMenu = RED.menu.init({id:"red-ui-debug-msg-option-menu",
                options: [
                    {id:"red-ui-debug-msg-menu-item-collapse",label:RED._("red-stack:debug.messageMenu.collapseAll"),onselect:function(){
                        activeMenuMessage.collapse();
                    }},
                    {id:"red-ui-debug-msg-menu-item-clear-pins",label:RED._("red-stack:debug.messageMenu.clearPinned"),onselect:function(){
                        activeMenuMessage.clearPinned();
                    }},
                    null,
                    {id:"red-ui-debug-msg-menu-item-filter", label:RED._("red-stack:debug.messageMenu.filterNode"),onselect:function(){
                        var candidateNodes = RED.nodes.filterNodes({type:'debug'});
                    ...
                    {id:"red-ui-debug-msg-menu-item-clear-filter",label:RED._("red-stack:debug.messageMenu.clearFilter"),onselect:function(){
    ...
    function clearFilterSettings() {
        ...
        $('#red-ui-sidebar-debug-filter span').text(RED._('red-stack:debug.sidebar.filterAll'));
