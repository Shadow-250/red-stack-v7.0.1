...
//
// 1. Create a copy of packages/node_modules/@red-stack/editor-client/src/sass/colors.scss
...
let colorsFile = fs.readFileSync(path.join(__dirname,"../packages/node_modules/@red-stack/editor-client/src/sass/colors.scss"),"utf-8")
let updatedColors = [];
...
const result = sass.renderSync({
    ...
    file: path.join(__dirname,"../packages/node_modules/@red-stack/editor-client/src/sass/style.scss"),
    importer: function(url, prev, done){
        ...
        return {file:"../packages/node_modules/@red-stack/editor-client/src/sass/"+url+".scss"}
    }
});
