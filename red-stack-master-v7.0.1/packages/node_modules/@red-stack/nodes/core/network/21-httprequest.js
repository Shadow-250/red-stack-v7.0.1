...
module.exports = function(RED) {
    ...
    function HTTPRequest(n) {
        ...
        this.on("input",function(msg,nodeSend,nodeDone) {
            ...
            if (msg.headers) {
                if (msg.headers.hasOwnProperty('x-red-stack-request-node')) {
                    var headerHash = msg.headers['x-red-stack-request-node'];
                    delete msg.headers['x-red-stack-request-node'];
            ...
            request(opts, function(err, res, body) {
                if(err){
                    ...
                    msg.headers['x-red-stack-request-node'] = hashSum(msg.headers);
