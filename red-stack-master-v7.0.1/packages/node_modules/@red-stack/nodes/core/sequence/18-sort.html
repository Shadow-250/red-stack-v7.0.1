...
<script type="text/x-red" data-template-name="sort">
    ...
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span data-i18n="red-stack:common.label.name"></span></label>
        <input type="text" id="node-input-name" data-i18n="[placeholder]red-stack:common.label.name">
    </div>
</script>
...
<script type="text/javascript">
    RED.nodes.registerType('sort',{
        ...
        oneditprepare: function() {
            var seq = {
                value: "seq",
                label: RED._("red-stack:sort.seq"),
                hasValue: false
            };
            var elem = {
                value: "elem",
                label: RED._("red-stack:sort.elem"),
                hasValue: false
            };
