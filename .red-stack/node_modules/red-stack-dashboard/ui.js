...
var mani = {
    "name": "RED-Stack Dashboard",
    "short_name": "Dashboard",
    "description": "A dashboard for RED-Stack",
    "start_url": "./#/0",
...
function addBaseConfig(config) {
    ...
    mani.name = config.site ? config.site.name : "RED-Stack Dashboard";
    mani.short_name = mani.name.replace("RED-Stack","").trim();
