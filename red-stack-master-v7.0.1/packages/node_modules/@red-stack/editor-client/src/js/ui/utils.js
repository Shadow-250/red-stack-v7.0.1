...
RED.utils = (function() {
    ...
    function addMessageControls(obj,sourceId,key,msg,rootPath,strippedKey,extraTools) {
        ...
        if (!!key) {
            ...
            RED.popover.tooltip(copyPath,RED._("red-stack:debug.sidebar.copyPath"));
        }
        ...
        RED.popover.tooltip(copyPayload,RED._("red-stack:debug.sidebar.copyPayload"));
        if (strippedKey !== undefined && strippedKey !== '') {
            ...
            RED.popover.tooltip(pinPath,RED._("red-stack:debug.sidebar.pinPath"));
        }
        if (extraTools) {
    ...
    function getDefaultNodeIcon(def,node) {
        ...
        if (node && node.type === "subflow") {
            icon_url = "red-stack/subflow.svg";
    ...
    function getNodeIcon(def,node) {
        if (def.category === 'config') {
            return RED.settings.apiRootUrl+"icons/red-stack/cog.svg"
        } else if (node && node.type === 'tab') {
            return RED.settings.apiRootUrl+"icons/red-stack/subflow.svg"
        } else if (node && node.type === 'unknown') {
            return RED.settings.apiRootUrl+"icons/red-stack/alert.svg"
        ...
        return RED.settings.apiRootUrl+"icons/red-stack/arrow-in.svg";
    }
    ...
    function createIconElement(iconUrl, iconContainer, isLarge) {
        ...
        if (iconPath.module === "font-awesome") {
            ...
            iconUrl = RED.settings.apiRootUrl+"icons/red-stack/arrow-in.svg"
        }
